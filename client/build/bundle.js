...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	  ReactDOM.render(React.createElement(CalculatorBox, null), document.getElementById('calculator'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Calculator = __webpack_require__(160);
	...
	var CalculatorBox = React.createClass({
	  ...
	  covertToPercent: function covertToPercent() {
	    var calculator = new Calculator();
	    var display = calculator.convertPercentage(this.state.display);
	    this.setState({ display: display });
	  },
	
	  reverseNegative: function reverseNegative(event) {
	  ...
	  joinArray: function joinArray(array) {
	    var result = "";
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'div',
	          { className: 'col-4 calculator-container' },
	          React.createElement(
	            'div',
	            { className: 'row' },
	            React.createElement(
	              'div',
	              { className: 'col-12' },
	              React.createElement('input', { type: 'text', className: 'number-display', value: this.state.display, readOnly: true })
	            )
	          ),
	          React.createElement(
	            'div',
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'button',
	                { value: 'C', className: 'calc-button operator', onClick: this.clearInput },
	                'C'
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement(
	                'button',
	                { value: '+/-', className: 'calc-button operator', onClick: this.reverseNegative },
	                '+/-'
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement(
	                'button',
	                { value: '%', className: 'calc-button operator', onClick: this.covertToPercent },
	                '%'
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement(
	                'button',
	                { value: '/', className: 'calc-button operator', onClick: this.HandleInputClick },
	                '/'
	              )
	            )
	          ),
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'button',
	                { value: '7', className: 'calc-button number', onClick: this.HandleInputClick },
	                '7'
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement(
	                'button',
	                { value: '8', className: 'calc-button number', onClick: this.HandleInputClick },
	                '8'
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement(
	                'button',
	                { value: '9', className: 'calc-button number', onClick: this.HandleInputClick },
	                '9'
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement(
	                'button',
	                { value: 'x', className: 'calc-button operator', onClick: this.HandleInputClick },
	                'X'
	              )
	            )
	          ),
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'button',
	                { value: '4', className: 'calc-button number', onClick: this.HandleInputClick },
	                '4'
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement(
	                'button',
	                { value: '5', className: 'calc-button number', onClick: this.HandleInputClick },
	                '5'
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement(
	                'button',
	                { value: '6', className: 'calc-button number', onClick: this.HandleInputClick },
	                '6'
	              )
	            ),
	            React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'button',
	                { value: '1', className: 'calc-button number', onClick: this.HandleInputClick },
	                '1'
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement(
	                'button',
	                { value: '2', className: 'calc-button number', onClick: this.HandleInputClick },
	                '2'
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement(
	                'button',
	                { value: '3', className: 'calc-button number', onClick: this.HandleInputClick },
	                '3'
	              )
	            ),
	            React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'button',
	                { value: '0', className: 'calc-zero-button number', onClick: this.HandleInputClick },
	                '0'
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement(
	                'button',
	                { value: '.', className: 'calc-button number', onClick: this.HandleInputClick },
	                '.'
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement(
	                'button',
	                { value: '=', className: 'calc-button operator', onClick: this.calculate },
	                '='
	              )
	            )
	          )
...
/***/ function(module, exports) {
	...
	Calculator.prototype = {
	  ...
	  calcInput: function calcInput(input) {
	    if (!input) {
	      return "0";
	    }
	    var splitInput = input.split(" ");
	    if (this.isInvalidInput(splitInput)) {
	      return "0";
	    }
	  ...
	  bodmasCalc: function bodmasCalc(splitInput, operatorArray) {
	  ...
	  isSelectedOperator: function isSelectedOperator(operator, operatorArray) {
	  ...
	  isSelectedOperatorInArray: function isSelectedOperatorInArray(inputArray, operatorArray) {
	    var _iteratorNormalCompletion = true;
	    var _didIteratorError = false;
	    var _iteratorError = undefined;
	    ...
	    try {
	      for (var _iterator = inputArray[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        ...
	        try {
	          for (var _iterator2 = operatorArray[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	  ...
	  isAnOperatorMultiOrDivide: function isAnOperatorMultiOrDivide(operator) {
	  ...
	  isAnOperatorAddOrSubtract: function isAnOperatorAddOrSubtract(operator) {
	  ...
	  convertPercentage: function convertPercentage(input) {
	  ...
	  isInvalidInput: function isInvalidInput(inputArray) {
	  ...
	  isAnOperator: function isAnOperator(operator) {
	  ...
	  calc: function calc(n1, n2, operator) {
	    n1 = parseFloat(n1);
	    n2 = parseFloat(n2);
